...
export const MenuToggle: React.FC<menuToggleProps> = ({ toggle, toggleState }) => (
  <div className="toggle-button-wrapper" onClick={toggle}>
    {toggleState ? <span>CLOSE</span> : <span>MENU</span>}
    <button className="toggle-button" aria-label="Toggle navigation menu">
      <motion.svg whileHover={{ width: 47, height: 15 }} width="57" height="20" viewBox="0 0 26 20">
        <Path
          variants={{
